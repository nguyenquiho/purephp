...
<div id="left_content">
  <div id="leftSide" style="padding-top:30px;"> 
    ...
    <ul id="menu" class="nav">
      ...
      <li class="tran"> <a href="chungloai.php" class="active exp" > <span>Chủng loại</span> <strong>
        <?php
	   $query1="SELECT * FROM doan_chungloai ";
		$data1 = mysqli_query($conn,$query1);
...
<div id="rightSide"> 
  ...
  <div class="topNav">
    <div class="wrapper">
      ...
      <div class="userNav">
        <ul>
          <li><a href="http://localhost/webphp/" target="_blank"> <img style="margin-top:7px;" src="image/home.png" /> <span>Trang chủ</span> </a></li>
          
          <!-- Logout -->
          <li><a href="home/logout.html"> <img src="image/logout.png" alt="" /> <span>Đăng xuất</span> </a></li>
        </ul>
      </div>
      <div class="clear"></div>
    </div>
  ...
  <div class="titleArea">
    <div class="wrapper">
      <div class="pageTitle">
        <h4>Chủng loại</h4>
        <span>Quản lý chủng loại</span> </div>
      <div class="horControlB menu_action">
        <ul>
          <li><a href="them_chungloai.php"> <img src="image/add.png" /> <span>Thêm mới</span> </a></li>
          <li><a href="user.html"> <img src="image/list.png" /> <span>Danh sách</span> </a></li>
        </ul>
      </div>
      <div class="clear"></div>
    </div>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
          ...
          <tbody>
			...
			$m= mysqli_fetch_array($data);
					...
					echo	"<td class='textC'>".$m['maCL']."</td>";
						
						
					echo	"<td><span title=".$m['tenCL']." class='tipS'>
							".$m['tenCL']."</span></td>";
			           	echo "<td class='option'>";
							echo "<a href='sua_chungloai.php?id=".$m['maCL']."' title='Chỉnh sửa' class='tipS '>";
							echo "<img src='image/edit.png' />";
							echo "</a>";
							
							echo "<a href='xoa_chungloai.php?id=".$m['maCL']."' title='Xóa' class='tipS verify_action' >";
