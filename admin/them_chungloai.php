...
<div class="titleArea">
    <div class="wrapper">
      <div class="pageTitle">
        <h5>Chủng loại sản phẩm</h5>
        <span>Quản lý chủng loại sản phẩm</span> </div>
      <div class="horControlB menu_action">
        <ul>
          <li><a href="admin/cat/add.html"> <img src="image/add.png" /> <span>Thêm mới</span> </a></li>
...
<form class="form" id="form" action="xuli_chungloai.php"  method="post" enctype="multipart/form-data">
      <fieldset>
        <div class="widget">
          <div class="title"> <img src="image/add.png" class="titleIcon" />
            <h5>Thêm mới chủng loại sản phẩm</h5>
          </div>
          <ul class="tabs">
            ...
            <div id='tab1' class="tab_content pd0">
             ...
             <div class="formRow">
                ...
                <div class="formRight"> <span class="oneTwo">
                  <input name="maCL" id="param_name" _autocheck="true" type="text"  />
       ...
       <div class="formRow">
                ...
                <div class="formRight"> <span class="oneTwo">
                  <input name="tenCL" id="param_name" _autocheck="true" type="text"  />
                  </span> <span name="name_autocheck" class="autocheck"></span>
                  <div name="name_error" class="clear error"></div>
                </div>
                <div class="clear"></div>
          ...
          <div class="formSubmit">
            <input type="submit" value="Thêm chủng loại sản phẩm" name="submit" class="redB" />
