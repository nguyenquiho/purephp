...
<div id="left_content">
  <div id="leftSide" style="padding-top:30px;"> 
    ...
    <ul id="menu" class="nav">
      ...
      <li class="product"> <a href="locsp.php" class="active exp" id="current"> <span>Sản phẩm</span> <strong>
        <?php
...
<div class="wrapper" id="main_product">
  <div class="widget">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable" id="checkAll">
      <thead class="filter">
        <tr>
          <td colspan="9"><form class="list_filter form" action="loc_tien.php" method="get" name="form1" id="form1">
			...
			?>
                    <td class="label" style="width:300px;"><label for="filter_status">Mã loại</label></td>
    ...
    <form action="" method="post" id="form2" name="form2">
      ...
      <?php 
		...
		while($m = mysqli_fetch_array($kq))
		{while($m1 = mysqli_fetch_array($kq3))
			{?>
      <tr class='row_18'>
        <td><input type='checkbox' name='id[]' value='18' /></td>
        <td><?php echo $m1['maLoai']; ?></td>
        <td><?php echo $m1['maSP']; ?></td>
        <td><?php echo $m1['tenSP']; ?></td>
        <td><?php echo $m1['giaSP']; ?></td>
        <td><?php echo $m1['thongTin']; ?></td>
        <td><?php echo $m1['hinhAnh']; ?></td>
        <td><?php echo $m1['SL']; ?></td>
        
        
        
        <td class="option" style="vertical-align:middle"><a href="suasp.php?id=<?php echo $m['maSP'] ?>&loai=<?php echo  $search ?> title="Chỉnh sửa" class="tipS">
    ...
    //Lùi 1 nhóm 
		if($gr>1) {?>
      <a href="loc_tien.php?gr=<?php echo $gr-1;?>&amp;loai=<?php echo $search ?>">&lt;&lt;</a>
      <?php } //In ra các trang từ $dau đến $cuoi của nhóm hiện hành: 
    	for($i=$dau;$i<=$cuoi;$i++){
    		...
    		if($page==$i){echo "<b><i>$i</b></i> &nbsp";} 
    			...
    			?>
      <a href="loc_tien.php?page=<?php echo $i;?>&amp;loai=<?php echo $search ?>"><?php echo $i;?>&nbsp</a>
      <?php }}
