      ...
      <li class="support"> <a href="admin/support.html" class="active exp" > <span>Đơn hàng</span> <strong> <?php
	   $query5="SELECT * FROM doan_donhang ";
		$data5 = mysqli_query($conn,$query5);
			...
			?></strong> </a>
        <ul class="sub">
          <li class="this" > <a href="doan_chitiethoadon.php"> Chi tiết hóa đơn</a> </li>
  ...
  <div class="titleArea">
    <div class="wrapper">
      ...
      <div class="horControlB menu_action">
        <ul>
          <li><a href="them_cthd.php"> <img src="image/add.png" /> <span>Thêm mới</span> </a></li>
        </ul>
      </div>
      <div class="clear"></div>
    </div>
    ...
    <div class="widget">
      ...
      <form action="http://localhost/webphp/index.php/admin/user.html" method="get" class="form" name="filter">
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
          ...
          <tfoot>
            <tr>
              <td colspan="15"><div class="list_action itemActions"> <a href="#submit" id="submit" class="button blueB" url="user/del_all.html"> <span style='color:white;'>Xóa hết</span> </a> </div>
          ...
          <tbody>
			...
			$m= mysqli_fetch_array($data);
					...
					echo	"<td><span title=".$m['maDH']." class='tipS'>
							".$m['maDH']."</span></td>";
							...
							".$m['giaSP']."</span></td>";
							echo	"<td><span title=".$m['thanhTien']." class='tipS'>
							".$m['thanhTien']."</span></td>";
						...
						echo "<td class='option'>";
							echo "<a href='sua_cthd.php?id=".$m['ID']."' title='Chỉnh sửa' class='tipS '>";
							echo "<img src='image/edit.png' />";
							echo "</a>";
							
							echo "<a href='xoa_cthd.php?id=".$m['ID']."' title='Xóa' class='tipS verify_action' >";
