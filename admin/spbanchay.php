  ...
  <div class="titleArea">
    <div class="wrapper">
      <div class="pageTitle">
        ...
        <span>Quản lý sản phẩm bán chạy</span> </div>
      <div class="horControlB menu_action">
        <ul>
          <li><a href="them_bchay.php"> <img src="image/add.png" /> <span>Thêm mới</span> </a></li>
          ...
          <tbody>
            ...
            <?php 
						...
						echo "<td class='option'>";
							echo "<a href='sua_bchay.php?id=".$m['maSP']."' title='Chỉnh sửa' class='tipS '>";
							echo "<img src='image/edit.png' />";
							echo "</a>";
							
							echo "<a href='xoa_bchay.php?id=".$m['maSP']."' title='Xóa' class='tipS verify_action' >";
