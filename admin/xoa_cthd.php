...
<div id="left_content">
  <div id="leftSide" style="padding-top:30px;"> 
    ...
    <ul id="menu" class="nav">
      ...
      <li class="product"> <a href="admin/product.html" class=" exp" id="current"> <span>Sản phẩm</span> <strong>5</strong> </a>
        <ul class="sub">
      ...
      <li class="support"> <a href="admin/support.html" class="active exp" > <span>Đơn hàng</span> <strong>2</strong> </a>
        <ul class="sub">
...
<div class="wrapper" id="main_product">
  <div class="widget">
    <div class="title"> <span class="titleIcon">
      ...
      <h4 align="center" > Sửa thông tin đơn hàng</h4>
    </div>
...
//nếu mà passw thì thêm md5($_POST['pass']); là định dạng ra sao
	...
	$add="delete from doan_chitiethoadon where ID='$id'   "or die("Lỗi truy vấn");
