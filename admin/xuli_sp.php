...
//nếu mà passw thì thêm md5($_POST['pass']); là định dạng ra sao
	...
	$data = mysqli_query($conn,$query);
		 ...
		 if(isset($_GET['search'])){
			$search = $_GET['search'];  
	$add=" INSERT INTO  doan_sp(maLoai,maSP,tenSP,giaSP,thongTin,hinhAnh) VALUES('$loai','$ma','$ten','$gia','$tt','$anh')  "or die("Lỗi truy vấn");
if(mysqli_query($conn, $add))// nếu thêm thành công
{  $search = $_GET['search']; 
 echo "<META http-equiv=\"refresh\" content=0;URL=http://localhost/doAn_MayTinh/admin/locsp.php?search=$search>";
} else {
