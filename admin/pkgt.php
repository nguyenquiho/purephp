...
<div id="rightSide"> 
  ...
  <div class="titleArea">
    <div class="wrapper">
      <div class="pageTitle">
        <h5>Phụ kiện giá tốt</h5>
        <span>Quản lý phụ kiện giá tốt</span> </div>
      <div class="horControlB menu_action">
        <ul>
          <li><a href="thempk.php"> <img src="image/add.png" /> <span>Thêm mới</span> </a></li>
          ...
          <tbody>
            ...
            <?php 
						...
						echo "<td class='option'>";
							echo "<a href='sua_pk.php?id=".$m['maSP']."' title='Chỉnh sửa' class='tipS '>";
							echo "<img src='image/edit.png' />";
							echo "</a>";
							
							echo "<a href='xoa_pk.php?id=".$m['maSP']."' title='Xóa' class='tipS verify_action' >";
