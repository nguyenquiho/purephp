...
<div class="wrapper" id="main_product">
	<div class="widget">
        ...
        <h1>Thêm sản phẩm</h1>
<form action="xuli_sp.php" method="post">
...
Giá sản phẩm:<input type="number" name="giaSP"><br>
Thông tin:<input type="text" name="thongTin"><br>
Hình ảnh:<input type="url" name="hinhAnh"><br>
