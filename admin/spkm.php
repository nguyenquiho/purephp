  ...
  <div class="titleArea">
    <div class="wrapper">
      <div class="pageTitle">
        ...
        <span>Quản lý sản phẩm khuyến mãi</span> </div>
      <div class="horControlB menu_action">
        <ul>
          <li><a href="them_km.php"> <img src="image/add.png" /> <span>Thêm mới</span> </a></li>
  ...
  <div class="wrapper">
    <div class="widget">
      <div class="title"> <span class="titleIcon">
        ...
        <h6>Danh sách sản phẩm khuyến mãi</h6>
          ...
          <tbody>
            ...
            <?php 
						...
						echo "<td class='option'>";
							echo "<a href='sua_km.php?id=".$m['maSP']."' title='Chỉnh sửa' class='tipS '>";
							echo "<img src='image/edit.png' />";
							echo "</a>";
							
							echo "<a href='xoa_km.php?id=".$m['maSP']."' title='Xóa' class='tipS verify_action' >";
