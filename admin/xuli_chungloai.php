...
<div id="left_content">
  <div id="leftSide" style="padding-top:30px;"> 
    ...
    <ul id="menu" class="nav">
      ...
      <li class="tran"> <a href="admin/tran.html" class="active exp" > <span>Chủng loại</span> <strong>5</strong> </a> </li>
...
<div class="wrapper" id="main_product">
  <div class="widget">
    <div class="title"> <span class="titleIcon">
      ...
      <h4 align="center" > Thêm chủng loại </h4>
    </div>
...
//nếu mà passw thì thêm md5($_POST['pass']); là định dạng ra sao
	...
	$add=" INSERT INTO  doan_chungloai(maCL,tenCL) VALUES('$ma','$ten')  "or die("Lỗi truy vấn");
