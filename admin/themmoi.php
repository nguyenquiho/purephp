...
<div class="formRow">
	...
	<div class="formRight">
		<span class="oneTwo">
			...
			<img class='tipS' title='Giá bán sử dụng để giao dịch' style='margin-bottom:-8px'  src='image/information.png'/>
		</span>
...
<div class="formRow">
	...
	<div class="formRight">
		<span>
			...
			<img class='tipS' title='Số tiền giảm giá' style='margin-bottom:-8px'  src='image/information.png'/>
		</span>
...
<div class="formRow">
	...
	<div class="formRight">
		...
		<?php while($m1= mysqli_fetch_array($data1))
		      while($m= mysqli_fetch_array($data))
						 
						 {
			      			          ...
			      			          echo "<optgroup label=".$m1['tenLoai'].">";
			               			  echo "<option value=".$m['maCL'].">".$m['tenLoai']."
					              				            </option>";
