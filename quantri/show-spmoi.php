...
<div id="mid">
	<!-- \Showw sp mới -->
		<?php
			$result=mysqli_query($link,"SELECT * FROM doan_sp_moi");
			$num=mysqli_num_rows($result);
			?>
			<div style="border-bottom: 1px solid black">
				<h3 style="margin-top: 25px;">Sản phẩm mới</h3>
				<span>Quản lí sản phẩm mới(<?php echo "$num"; ?>)</span>
				<a href="add.php?key=spm">
			...
			<div>
				<table border="1px" style="width: 98%; border-collapse: collapse;margin-top: 20px;border-color: white">
					<tr>
						<th colspan="6" bgcolor="DarkSlateGray" style="color: white" align="left" height="30">Danh sách sản phẩm mới</th>
					</tr>
					...
					<th><a href="delete.php?key=spmoi&masp=<?php echo $d['maSP']; ?>">Xoá</a>&nbsp &nbsp<a href="update.php?masp=<?php echo $d['maSP']; ?>">Sửa</a></th>
				</tr>
					<?php $stt++; } ?>
				</table>
			</div>
