...
<div id="mid">
	<!-- \Showw sp bán chạy -->
		<?php
			$result=mysqli_query($link,"SELECT * FROM doan_sp_banchay");
			$num=mysqli_num_rows($result);
			?>
			<div style="border-bottom: 1px solid black">
				<h3 style="margin-top: 25px;">Sản phẩm bán chạy</h3>
				<span>Quản lí sản phẩm bán chạy(<?php echo "$num"; ?>)</span>
				<a href="add.php?key=spbc">
			...
			<div>
				<table border="1px" style="width: 98%; border-collapse: collapse;margin-top: 20px;border-color: white">
					<tr>
						<th colspan="6" bgcolor="DarkSlateGray" style="color: white" align="left" height="30">Danh sách sản phẩm bán chạy</th>
					</tr>
