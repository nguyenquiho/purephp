...
<div id="mid">
	<!-- \Showw sp km -->
		<?php
			$result=mysqli_query($link,"SELECT * FROM doan_sp_km");
			$num=mysqli_num_rows($result);
			?>
			<div style="border-bottom: 1px solid black">
				<h3 style="margin-top: 25px;">Sản phẩm khuyến mãi</h3>
				<span>Quản lí sản phẩm khuyến mãi(<?php echo "$num"; ?>)</span>
				<a href="add.php?key=spkm">
			...
			<div>
				<table border="1px" style="width: 98%; border-collapse: collapse;margin-top: 20px;border-color: white">
					<tr>
						<th colspan="6" bgcolor="DarkSlateGray" style="color: white" align="left" height="30">Danh sách sản phẩm khuyến mãi</th>
					</tr>
